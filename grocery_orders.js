document.addEventListener('DOMContentLoaded', () => {
    ...
    let supplierNameMap = {}; // לשמירת שם הספק לפי ID

    // פונקציה לשליפת רשימת הספקים
    ...
    // פונקציה לשליפת רשימת המוצרים של ספק נבחר
        ...
        try {
            ...
            if (response.ok) {
                ...
                data.forEach(product => {
                    ...
                    label.textContent = `${product.name} (מחיר: ${product.price}): `;
